-- ============================================================
-- BIM Knowledge Hub — Supabase Schema
-- আকিব | BGFCL | BIM Special Foundation Training
-- ============================================================
...
create table public.profiles (
  ...
  batch text default 'BIM Special Foundation Training 2025',
  avatar_url text,
...
comment on table public.profiles is 'প্রতিটা BIM ট্রেইনির প্রোফাইল তথ্য';
...
-- ------------------------------------------------------------
-- 10) প্রথম ADMIN বানানো (নিজে নিজে করতে হবে)
-- ------------------------------------------------------------
