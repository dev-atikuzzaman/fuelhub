...
export const THEMES = {
  ...
  blackDark: {
    ...
    emoji: '⚫',
    colors: {
      // VS Code এর "Dark High Contrast" এর কাছাকাছি — pure black ভিত্তিক
      bgBase: '#000000',
      bgSurface: '#0d0d0d',
      bgSurfaceAlt: '#1a1a1a',
      bgHeader: 'rgba(0,0,0,0.95)',
      ...
      accent: '#22d3ee',
      accentDark: '#0e7490',
      accentGradient: 'linear-gradient(135deg, #22d3ee, #0e7490)',
      accentSoft: '#083344',
  ...
  githubIndigo: {
    ...
    emoji: '🐙',
    colors: {
      // GitHub এর "Dark Dimmed" / Indigo accent থেকে অনুপ্রাণিত
      bgBase: '#1c2128',
      bgSurface: '#22272e',
      bgSurfaceAlt: '#2d333b',
      bgHeader: 'rgba(28,33,40,0.92)',
      ...
      accent: '#6e7fee',
      accentDark: '#4356d9',
      accentGradient: 'linear-gradient(135deg, #6e7fee, #4356d9)',
      accentSoft: '#252c63',
...
export const THEME_ORDER = ['light', 'dark', 'blackDark', 'andromeda', 'githubIndigo'];
