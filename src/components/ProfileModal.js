...
import { XIcon, MailIcon, PhoneIcon, MapPinIcon, BuildingIcon, GraduationIcon, EditIcon, CheckIcon, LoaderIcon, LockIcon, EyeIcon, EyeOffIcon } from './Icons';
            ...
            <div style={{ marginTop: 16, borderTop: '1px solid #f1f5f9', paddingTop: 16 }}>
              <button
                ...
                style={{
                  ...
                  color: '#0ea5e9', fontSize: 13.5, fontWeight: 700, cursor: 'pointer', padding: 0,
                }}
              >
              ...
              {showPasswordForm && (
                <div style={{ marginTop: 12, background: '#f8fafc', borderRadius: 14, padding: 14 }}>
                  {pwdError && (
                    <div style={{ background: '#fee2e2', color: '#dc2626', padding: '8px 12px', borderRadius: 8, fontSize: 12.5, marginBottom: 10 }}>
                      {pwdError}
                    </div>
                  )}
                  {pwdSuccess && (
                    <div style={{ background: '#dcfce7', color: '#16a34a', padding: '8px 12px', borderRadius: 8, fontSize: 12.5, marginBottom: 10 }}>
                      {pwdSuccess}
                    </div>
                  )}
                  ...
                  <div style={{ position: 'relative', marginBottom: 8 }}>
                    <input
                      ...
                      style={{ width: '100%', padding: '9px 36px 9px 10px', borderRadius: 9, border: '1.5px solid #e2e8f0', fontSize: 13, outline: 'none', boxSizing: 'border-box' }}
                    />
                  </div>
                  <div style={{ position: 'relative', marginBottom: 8 }}>
                    <input
                  ...
                  <div style={{ position: 'relative', marginBottom: 10 }}>
                    ...
                    <button
                      ...
                      style={{ position: 'absolute', right: 8, top: 8, background: 'none', border: 'none', cursor: 'pointer', color: '#94a3b8', padding: 2 }}
                      tabIndex={-1}
                    >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'linear-gradient(135deg, #0ea5e9, #1e3a5f)', color: '#fff', fontWeight: 700,
